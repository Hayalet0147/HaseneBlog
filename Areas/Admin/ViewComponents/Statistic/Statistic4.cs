...
namespace Tekno_Yazılım.Areas.Admin.ViewComponents.Statistic
{
    public class Statistic4 : ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            ViewBag.v5 = c.Admins.Where(x => x.AdminId == writerid).Select(y => y.PhoneNumber).FirstOrDefault();

            ViewBag.tümbildirim = c.Notifications.Select(x => x.NotificationId).Count();
            return View();
        }
    }
}
